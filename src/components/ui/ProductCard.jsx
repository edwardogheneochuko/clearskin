      ...
      {!hero && (
        <div className="mt-2 space-y-1 sm:mt-3">
          <div className="flex items-center gap-2">
            {item.oldPrice && (
              <span className="text-xs text-gray-400 dark:text-gray-500 line-through sm:text-sm">
                ${item.oldPrice}
              </span>
            )}
            <span className="text-base font-semibold sm:text-lg text-gray-900 dark:text-white">
              ${item.price}
            </span>
          </div>
          ...
          <h3
            ...
            className="text-xs text-gray-800 dark:text-gray-200
                       transition group-hover:text-black dark:group-hover:text-white
                       sm:text-sm cursor-pointer hover:text-pink-400 dark:hover:text-pink-400"
          >
            {item.title}
          </h3>
