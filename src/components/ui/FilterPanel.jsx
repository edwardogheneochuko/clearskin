...
const FilterContent = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <label className="text-xs font-medium text-gray-500 block mb-2">Search</label>
        <input
          value={search}
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-xs text-gray-400">${minPrice} — {maxPrice >= 100 ? "$100+" : `$${maxPrice}`}</span>
        </div>
      ...
      <div>
        <label className="text-xs font-medium text-gray-500 block mb-2">Min Rating</label>
            ...
            <button
              ...
              className={`flex-1 py-2 rounded-lg text-xs font-medium transition cursor-pointer border
                ${minRating === r
                  ...
                  : "bg-gray-100 text-gray-600 border-transparent hover:border-pink-300"
                }`}
            >
              {r}★
            </button>
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            <motion.div
              key="drawer"
              className="fixed top-0 right-0 z-50 h-full w-[80%] sm:w-[360px] bg-white shadow-xl overflow-y-auto md:hidden"
              initial={{ x: "100%" }}
              animate={{ x: 0 }}
              exit={{ x: "100%" }}
      ...
      <div className="hidden md:block w-56 shrink-0">
        <div className="sticky top-28 bg-white rounded-2xl border shadow-sm p-5">
